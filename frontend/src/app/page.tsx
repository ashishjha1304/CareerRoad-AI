            ...
            <div className="container mx-auto px-4 bg-primary rounded-[3rem] py-16 text-center text-primary-foreground relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link href="#features">
                            <Button size="lg" className="h-14 px-10 text-lg font-bold rounded-2xl border border-white/20 text-white hover:bg-white/10 !bg-transparent w-full sm:w-auto shadow-none">
                                Explore Features
                            </Button>
                        </Link>
                    </div>
